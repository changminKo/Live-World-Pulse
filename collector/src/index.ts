/** Live World Pulse — Phase 0a Collector 엔트리.
...
import { isHalted, isScanSlot, runDailyCapacityScan } from './r2/capacity';
...
export default {
  async scheduled(controller: ScheduledController, env: Env, _ctx: ExecutionContext): Promise<void> {
    ...
    if (await isHalted(env.DATA)) {
      console.log(JSON.stringify({ scheduledAt, halted: true, capacity }));
