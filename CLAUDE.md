...
현재 단계: **Phase -1 완료 → Phase 0a (Collector First) 진입 가능** — 엔진 A(maplibre ~5.24 globe + deck.gl overlaid) 확정, 판정 근거 docs/spike/RESULT.md. (Phase 전환 시 이 줄을 갱신할 것)
...
- 작성자와 리뷰어는 항상 분리 (같은 워커/컨텍스트에서 자기 승인 금지).
