...
현재 단계: **Phase -1 완료 → Phase 0a (Collector First) 진입 가능** — 엔진 A(maplibre ~5.24 globe + deck.gl overlaid) 확정, 판정 근거 docs/spike/RESULT.md. 이월 미완: 디자인 방향 1페이지(Phase 0 전 필수), RESULT §이관 7~9. (Phase 전환 시 이 줄을 갱신할 것)
