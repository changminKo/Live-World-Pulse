...
| 5 | z0↔z14 왕복 무결 | N₂=9976 보존, JS 에러 0 ✅ | N₂=9829 보존, 에러 0 | N₂=10652 보존, 에러 0 ✅ (z12+ 지터: 미확정) |
...
**규칙 1 준용: A가 기준 1·2·3·5·6 전부 통과, 기준 4는 5/6 O + 미확정 1건(Arc 관통 — 실패 관찰 없음)** (원문 '전부 통과'의 준용 — 규칙 2 경로로 가도 C가 기준 4 명백 실패라 결론 불변) → **A (maplibre-gl 5.24 globe + MapboxOverlay overlaid) 확정.**
